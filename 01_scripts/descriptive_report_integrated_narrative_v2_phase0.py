...
# Paths
HOUSEHOLD_PATH = Path("/Users/emersonrburke/Desktop/working/working_thesis_211125/WFL-Analysis/02_outputs/datasets/phase_0_household_processed.csv")
VENDOR_PATH = Path("/Users/emersonrburke/Desktop/working/working_thesis_211125/WFL-Analysis/02_outputs/datasets/phase_0_vendor_processed.csv")
...
summary_df.to_csv(OUTPUT_DIR / "Table_INTEGRATED_Summary_Comparison_v2.csv", index=False)
...
narrative_text = '\n'.join(narrative)
output_file = OUTPUT_DIR / "INTEGRATED_NARRATIVE_REPORT_v2.md"
...
print("\nAdditional Table:")
print("  - Table_INTEGRATED_Summary_Comparison_v2.csv")
print("\n" + "=" * 80)
