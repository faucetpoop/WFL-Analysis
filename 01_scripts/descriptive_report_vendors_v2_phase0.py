...
# Paths
DATA_PATH = Path("/Users/emersonrburke/Desktop/working/working_thesis_211125/WFL-Analysis/02_outputs/datasets/phase_0_vendor_processed.csv")
...
table_v1a.to_csv(OUTPUT_DIR / "Table_V1A_Vendor_Demographics_Continuous_v2.csv", index=False)
...
table_v1b.to_csv(OUTPUT_DIR / "Table_V1B_Vendor_Demographics_Categorical_v2.csv", index=False)
...
table_v2a.to_csv(OUTPUT_DIR / "Table_V2A_Vendor_Geographic_Distribution_v2.csv", index=False)
...
if foodgroup_cols:
    ...
    table_v3a.to_csv(OUTPUT_DIR / "Table_V3A_Food_Groups_Sold_v2.csv", index=False)
...
if foodgroup_cols:
    ...
    diversity_stats.to_csv(OUTPUT_DIR / "Table_V3B_Vendor_Product_Diversity_v2.csv", index=False)
...
if 'wholeorprocessed' in df.columns:
    ...
    table_v4a.to_csv(OUTPUT_DIR / "Table_V4A_Whole_vs_Processed_Foods_v2.csv", index=False)
    print("\n✓ Table V4A: Whole vs Processed Foods")
...
table_v5_summary.to_csv(OUTPUT_DIR / "Table_V5_Vendor_Integrated_Summary_v2.csv", index=False)
